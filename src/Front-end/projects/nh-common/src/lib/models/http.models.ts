...
export class HttpRequestOptionsArrayBuffer implements IHttpRequestOptions {
  headers?: HttpHeaders;
  observe?: 'body';
  params?: HttpParams;
  reportProgress?: boolean;
...
export class CollectionHttpRequestOptions extends SearchableCollectionHttpRequestOptions implements ICollectionHttpRequestOptions {
  ...
  public like(key: string, value: string, tag?: string): this {
    this.and(FilterRequestOptions.like(key, value, tag));
    return this;
  }
