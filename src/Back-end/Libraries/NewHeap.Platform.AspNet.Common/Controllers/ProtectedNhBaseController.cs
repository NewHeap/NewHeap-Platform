...
public abstract partial class ProtectedNhBaseController : NhBaseController
{
    ...
    [NonAction]
    protected virtual void ConfigureCollectionProcessing<TEntity, TViewModel>(CollectionProcessingOptionsBuilder<TEntity, TViewModel> options)
        where TEntity : class
    ...
    protected virtual Task<IQueryable<TEntity>> GetCollectionResultQuery<TEntity, TViewModel>(
        ...
        where TViewModel : class
    {
        return _httpCollectionProcessingService.GetCollectionResultQueryAsync<TEntity, TViewModel>(queryable, options => ConfigureCollectionProcessing(options), cancellationToken, defaultOrderBy);
    }
    ...
    protected virtual Task<IQueryable<TEntity>> GetCollectionResultQuery<TEntity, TViewModel>(
        ...
        where TViewModel : class
    {
        return _httpCollectionProcessingService.GetCollectionResultQueryAsync<TEntity, TViewModel>(queryable, options => ConfigureCollectionProcessing(options), cancellationToken: cancellationToken);
    }
        ...
        where TViewModel : class
    {
        return _httpCollectionProcessingService.GetCollectionResultModelAsync<TEntity, TViewModel>(
            requestModel,
            queryable,
            options => ConfigureCollectionProcessing(options),
            resultQueryableFunc,
            asNoTracking,
            cancellationToken,
            defaultOrderBy
