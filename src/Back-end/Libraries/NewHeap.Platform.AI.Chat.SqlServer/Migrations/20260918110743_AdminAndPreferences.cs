        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructionsAssetId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    InstructionsAssetVersion = table.Column<int>(type: "int", nullable: false),
                    InstructionsHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ToolSelectorsJson = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: false),
                    RequiredPolicy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Autonomy = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeaderName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ProtectedSecret = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    RequiredPolicy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    LastSyncAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    LastSyncStatus = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Style = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    AddressForm = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    ResponseLength = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    McpServerId = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServerId = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    RemoteName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    LocalId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    InputSchemaHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    Effect = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    DescriptionOverride = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ReadOnlyHint = table.Column<bool>(type: "bit", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
