...
public-symbols: ["CapTransactionScope", "INhBackgroundOperationContext", "INhBackgroundOperationFanOutContext", "INhBackgroundOperationHandler<TRequest>", "INhBackgroundOperationLeaseManager", "INhBackgroundOperationNotificationFormatter", "INhNotificationDispatcher", "INhUserNotificationService", "NhBackgroundOperationBuilder", "NhBackgroundOperationChangedMessage", "NhBackgroundOperationFanOut", "NhBackgroundOperationResourceKey", "NhBackgroundOperationRetryResult", "NhBackgroundOperationStore", "NhBackgroundOperationsOptions", "NhHangfireUtil", "NhMailService", "NhNotificationSettings", "NhUserNotificationService", "TaskResult"]
