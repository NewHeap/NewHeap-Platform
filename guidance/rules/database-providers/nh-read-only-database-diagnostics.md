...
summary: "Use newheap-db with checked-in profiles and typed JSON parameters while keeping connection strings in the existing NewHeap configuration and secrets flow."
sample-cases: ["SPM-218"]
public-symbols: ["NewHeapDatabaseReadApplication", "UseNhCommonConfiguration"]
