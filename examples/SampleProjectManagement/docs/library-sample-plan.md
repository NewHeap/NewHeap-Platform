...
| SPM-242 | API bridge catalog over MVC controllers | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-243 | API bridge tools over MCP with attested catalog | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-244 | Attested catalog validation rejects ungoverned functions | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-245 | Assistant conversation with streamed turn | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-246 | Assistant mutation paused for approval and resumed | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-247 | Durable assistant budget and idempotency ledgers | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-248 | Assistant panel in the management portal | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
| SPM-249 | End-to-end assistant over bridge and curated tools | TODO: reserved for the AI assistant and API bridge work; the owning lane fills this entry. | TODO: planned; the owning lane replaces this outcome with the verified behavior and evidence. |
