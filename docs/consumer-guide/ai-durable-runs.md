...
- [Run approval-gated AI work inside durable background operations](#run-approval-gated-ai-work-inside-durable-background-operations)

## Run approval-gated AI work inside durable background operations

Use background operations as the outer durability boundary and persist application state plus versioned checkpoint references instead of treating chat history as authoritative state.
