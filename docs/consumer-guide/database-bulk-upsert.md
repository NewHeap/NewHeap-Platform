...
Use ExecuteUpsertAsync for immediate, untracked imports backed by SQL Server bulk copy and MERGE or PostgreSQL binary COPY and ON CONFLICT.
...
- SPM-053 — Provider-native bulk upsert
