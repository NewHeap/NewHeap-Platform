...
- [Immutable guide and executable evidence](https://github.com/NewHeap/NewHeap-Platform/blob/newheap-platform-plugin-v1.11.7/docs/consumer-guide/frontend-collection-query.md#fluent-collections-filtering-and-ordering)
