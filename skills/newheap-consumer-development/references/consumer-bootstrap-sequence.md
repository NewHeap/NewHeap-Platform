...
- [Immutable guide and executable evidence](https://github.com/NewHeap/NewHeap-Platform/blob/newheap-platform-plugin-v1.12.0/docs/consumer-guide/consumer-bootstrap-sequence.md#bootstrap-an-empty-consumer-before-feature-work)
