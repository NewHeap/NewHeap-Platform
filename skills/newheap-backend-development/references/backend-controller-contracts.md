...
- [Immutable guide and executable evidence](https://github.com/NewHeap/NewHeap-Platform/blob/newheap-platform-plugin-v1.12.0/docs/consumer-guide/backend-controller-contracts.md#controllers-and-scalar-as-an-executable-contract)
