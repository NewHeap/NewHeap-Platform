...
- [Immutable guide and executable evidence](https://github.com/NewHeap/NewHeap-Platform/blob/newheap-platform-plugin-v1.11.8/docs/consumer-guide/testing.md#separate-reusable-test-helpers-from-library-tests)
