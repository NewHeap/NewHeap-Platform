...
- [Immutable guide and executable evidence](https://github.com/NewHeap/NewHeap-Platform/blob/newheap-platform-plugin-v1.11.6/docs/consumer-guide/authentication-overrides.md#authentication-overrides-and-claim-hydration)
