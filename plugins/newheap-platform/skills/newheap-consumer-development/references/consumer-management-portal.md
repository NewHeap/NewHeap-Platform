...
- [Immutable guide and executable evidence](https://github.com/NewHeap/NewHeap-Platform/blob/newheap-platform-plugin-v1.11.6/docs/consumer-guide/consumer-management-portal.md#use-a-newheap-management-portal-for-confirmed-interactive-work)
